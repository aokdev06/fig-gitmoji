  ...
  subcommands: [
    {
      icon: "✨",
      name: "sparkles",
      insertValue: "\b\b\bgit commit -m ':sparkles: {cursor}'",
      description: "Yeni bir özellik ekleniyorsa",
    },
    {
      icon: "🎨",
      name: "art",
      insertValue: "\b\b\bgit commit -m ':art: {cursor}'",
      description:
    ...
    },
    {
      icon: "🐛",
      name: "bug",
      insertValue: "\b\b\bgit commit -m ':bug: {cursor}'",
      description: "Yapılan değişiklik bir Bug'ı içeriyorsa",
    },
    {
      icon: "✅",
      name: "test",
      insertValue: "\b\b\bgit commit -m ':white_check_mark: {cursor}'",
      description:
    ...
    },
    {
      icon: "🚑️",
      name: "ambulance",
      insertValue: "\b\b\bgit commit -m ':ambulance: '",
      description:
